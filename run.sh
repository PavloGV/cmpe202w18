...
# 			sudo python noisy_sine.py -l ${inputSizes[index]} -t $t
# 			sudo perf stat -I $instCountNum -e cpu-cycles,instructions,branch-instructions,branch-misses,L1-dcache-load,LLC-loads -x, -o intermediate.csv python read_signal.py; python ../../../../../pmu-tools/interval-normalize.py intermediate.csv > normOut.csv
# 			sudo python plotMyData.py -f normOut.csv -d $d -m $m -t $t
# 			index=$(( $index + 1 ))	
# 		done
# 		index=0
# 	done
...
# #sudo python noisy_sine.py -l 1350 -t 1
# sudo python noisy_sine.py -l 200 -t 1
# while [ $index -lt $instCountNum ]
# do
# 	sudo perf stat -I 100 -e cycles -x, -o intermediate.csv python read_signal.py; python ../../../../../pmu-tools/interval-normalize.py intermediate.csv > normOut.csv
# 	sudo python get_run_time.py -f normOut.csv -n $index
# 	echo 'run: '$index
# 	index=$(( $index + 1 ))
# done
# sudo python plotLatency.py
